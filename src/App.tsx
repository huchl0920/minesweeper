          ...
          <>
            ...
            <div className="hero-card">
              ...
              <div className="hero-weather-label">
                <span className="hero-icon">{getWeatherEmoji(current.weather_code, current.is_day)}</span>
                {getWeatherDesc(current.weather_code)}
              </div>
              <div className="hero-temp">{Math.round(current.temperature)}<span className="hero-deg">°</span></div>
              <div className="hero-sub">體感溫度：{Math.round(current.apparent_temperature)}°</div>
              <div className="hero-range">
                最高溫：{Math.round(daily.temperature_2m_max[0])}° · 最低溫：{Math.round(daily.temperature_2m_min[0])}°
              </div>
            </div>
